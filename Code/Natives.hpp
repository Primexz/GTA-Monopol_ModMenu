...
namespace PLAYER
{
	typedef Player(__fastcall* GetPlayerByIndex_t)(int player);
	static Player GetPlayerByIndex(int player) { static GetPlayerByIndex_t oGetPlayerByIndex = (GetPlayerByIndex_t)(Memory::pattern("74 1C 83 F9 1F").count(1).get(0).get<void>()); return oGetPlayerByIndex(player); }
	...
	/*typedef Ped(__fastcall* GETPLAYERPEDSCRIPTINDEX)(Player player);
	static Ped GET_PLAYER_PED_SCRIPT_INDEX(Player player) { static GETPLAYERPEDSCRIPTINDEX oPLAYERPEDSCRIPTINDEX = (GETPLAYERPEDSCRIPTINDEX)(Memory::pattern("48 8B ? 48 83 F8 18 0F 85 ? ? ? ? E9 ? ? ? ?").count(1).get(0).get<void>()); return oPLAYERPEDSCRIPTINDEX(player); }*/
	...
	static char* GET_PLAYER_NAME(Player player) { static tGET_PLAYER_NAME oGET_PLAYER_NAME = (tGET_PLAYER_NAME)(Memory::pattern("40 53 48 83 EC 20 80 3D ? ? ? ? ? 8B D9 74 22 33 D2 E8 ? ? ? ? 48 85 C0").count(1).get(0).get<void>()); return oGET_PLAYER_NAME(player); }

	//40 53 48 83 EC 20 80 3D ? ? ? ? ? 8B D9 74 22
...
namespace VEHICLE
{
	static int _GET_HEADLIGHT_COLOR(Vehicle vehicle) { return invoke<int>(0x3DFF319A831E0CDB, vehicle); } // 0x3DFF319A831E0CDB since b1604
	static void _SET_HEADLIGHT_COLOR(Vehicle vehicle, int value) { invoke<Void>(0xE41033B25D003A07, vehicle, value); } // 0xE41033B25D003A07 since b1604
	bool IsToggleModOn(Vehicle vehicle, int TGModType) { return VEHICLE::IsToggleModOn(vehicle, TGModType) != 0; }
...
namespace OBJECT
{
	static Object CREATE_OBJECT2(Hash modelHash, float x, float y, float z, BOOL isNetwork, BOOL thisScriptCheck, BOOL dynamic) { return invoke<Object>(0x509D5878EB39E842, modelHash, x, y, z, isNetwork, thisScriptCheck, dynamic); } // 0x509D5878EB39E842 0x2F7AA05C
	typedef Object(__fastcall* tCREATE_OBJECT)(Hash modelHash, float x, float y, float z, bool offset, int unk0, int unk1, Object* out, bool isNetwork, BOOL thisScriptCheck, bool dynamic);
	static Object CREATE_OBJECT(Hash modelHash, float x, float y, float z, bool offset, int unk0, int unk1, Object* out, bool isNetwork, BOOL thisScriptCheck, bool dynamic) { static tCREATE_OBJECT oCREATE_OBJECT = (tCREATE_OBJECT)(Memory::pattern("48 8B C4 48 89 58 08 48 89 70 10 48 89 78 18 4C 89 60 20 55 41 55 41 56 48 8D 68 D9").count(1).get(0).get<void>()); return oCREATE_OBJECT(modelHash, x, y, z, offset, unk0, unk1, out, *g_GameVariables->is_session_started, false, dynamic); }
...
namespace GAMEPLAY
{
	...
	static Hash GET_HASH_KEY(const std::string &str)
	{
		size_t len = str.size();
		unsigned int hash, i;
	...
	static Hash NORMAL_GET_HASH_KEY(const char* string) { return invoke<Hash>(0xD24D37CC275948CC, string); } // 0xD24D37CC275948CC 0x98EFF6F1
...
namespace AUDIO
{
	...
	typedef int(__fastcall* tGET_PLAYER_RADIO_STATION_INDEX)();
	static int GET_PLAYER_RADIO_STATION_INDEX() { static tGET_PLAYER_RADIO_STATION_INDEX oGET_PLAYER_RADIO_STATION_INDEX = (tGET_PLAYER_RADIO_STATION_INDEX)(Memory::pattern("48 83 EC 28 48 8D 0D ? ? ? ? E8 ? ? ? ? 48 85 C0 74 0C").count(1).get(0).get<void>()); return oGET_PLAYER_RADIO_STATION_INDEX(); }
	...
	typedef char* (__fastcall* tGET_RADIO_STATION_NAME)(int radioStation);
	static char* GET_RADIO_STATION_NAME(int radioStation) { static tGET_RADIO_STATION_NAME oGET_RADIO_STATION_NAME = (tGET_RADIO_STATION_NAME)(Memory::pattern("48 83 EC 28 E8 ? ? ? ? 48 85 C0 74 0D 48 8B 80").count(1).get(0).get<void>()); return oGET_RADIO_STATION_NAME(radioStation); }
...
typedef BOOL(__fastcall* tIS_AIM_CAM_ACTIVE)();
		static BOOL IS_AIM_CAM_ACTIVE() { static tIS_AIM_CAM_ACTIVE oIS_AIM_CAM_ACTIVE = (tIS_AIM_CAM_ACTIVE)(Memory::pattern("48 89 5C 24 ? 57 48 83 EC 20 E8 ? ? ? ? 33 D2 48 8B C8 48 8B F8").count(1).get(0).get<void>()); return oIS_AIM_CAM_ACTIVE(); }
...
namespace WEAPON
{
	...
	typedef BOOL(__fastcall* tGET_CURRENT_PED_WEAPON)(Ped ped, Hash* weaponHash, BOOL p2);
	static BOOL GET_CURRENT_PED_WEAPON(Ped ped, Hash* weaponHash, BOOL p2) { static tGET_CURRENT_PED_WEAPON oGET_CURRENT_PED_WEAPON = (tGET_CURRENT_PED_WEAPON)(Memory::pattern("40 53 48 83 EC 20 48 8B DA E8 ? ? ? ? 33 C9").count(1).get(0).get<void>()); return oGET_CURRENT_PED_WEAPON(ped, weaponHash, p2); }
	...
	//static void REMOVE_ALL_PED_WEAPONSSteam(Ped ped, BOOL p1) { invoke<Void>(0xF25DF915FA38C5F3, ped, p1); } // 0xF25DF915FA38C5F3 0xA44CE817
	typedef void(__fastcall* tREMOVE_ALL_PED_WEAPONS)(Ped ped, BOOL toggle);
	static void REMOVE_ALL_PED_WEAPONS(Ped ped, BOOL toggle) { static tREMOVE_ALL_PED_WEAPONS oREMOVE_ALL_PED_WEAPONS = (tREMOVE_ALL_PED_WEAPONS)(Memory::pattern("48 83 EC 28 8B 05 ? ? ? ? 89 05 ? ? ? ? E8").count(1).get(0).get<void>()); return oREMOVE_ALL_PED_WEAPONS(ped, toggle); }
	...
	typedef void(__fastcall* tREMOVE_WEAPON_FROM_PED)(Ped ped, Hash weaponHash);
	static void REMOVE_WEAPON_FROM_PED(Ped ped, Hash weaponHash) { static tREMOVE_WEAPON_FROM_PED oREMOVE_WEAPON_FROM_PED = (tREMOVE_WEAPON_FROM_PED)(Memory::pattern("48 89 5C 24 ? 57 48 83 EC 20 8B FA E8 ? ? ? ? 33 DB").count(1).get(0).get<void>()); return oREMOVE_WEAPON_FROM_PED(ped, weaponHash); }
...
namespace STREAMING
{
	...
	inline void REQUEST_ANIM_DICT2(const char* animDict) { invoke<Void>(0xD3BD40951412FEF6, animDict); } // 0xD3BD40951412FEF6 0xDCA96950
	...
	static BOOL REQUEST_MODEL(Hash model) { static tREQUEST_MODEL oREQUEST_MODEL = (tREQUEST_MODEL)(Memory::pattern("48 89 5C 24 ? 48 89 7C 24 ? 55 48 8B EC 48 83 EC 50 8B 45 18").count(1).get(0).get<void>()); return oREQUEST_MODEL(model); }
	...
	static bool HAS_MODEL_LOADED(Hash model) { static tHAS_MODEL_LOADED oHAS_MODEL_LOADED = (tHAS_MODEL_LOADED)(Memory::pattern("48 89 7C 24 ? 55 48 8B EC 48 83 EC 20 8B 45 18 BF").count(1).get(0).get<void>()); return oHAS_MODEL_LOADED(model); }
	...
	static BOOL SET_MODEL_AS_NO_LONGER_NEEDED(DWORD hash) { static tSET_MODEL_AS_NO_LONGER_NEEDED oSET_MODEL_AS_NO_LONGER_NEEDED = (tSET_MODEL_AS_NO_LONGER_NEEDED)(Memory::pattern("40 53 48 83 EC 30 48 8D 54 24 ? 8B D9").count(1).get(0).get<void>()); return oSET_MODEL_AS_NO_LONGER_NEEDED(hash); }
	//static BOOL IS_MODEL_IN_CDIMAGE(Hash model) { return invoke<BOOL>(0x35B9E0803292B641, model); } // 0x35B9E0803292B641 0x1094782F
	typedef BOOL(__fastcall* tIS_MODEL_IN_CDIMAGE)(DWORD hash);
	static BOOL IS_MODEL_IN_CDIMAGE(DWORD hash) { static tIS_MODEL_IN_CDIMAGE oIS_MODEL_IN_CDIMAGE = (tIS_MODEL_IN_CDIMAGE)(Memory::pattern("48 83 EC 28 8B 44 24 38 48 8D 54 24 ? C7 44 24 ? ? ? ? ? 0D ? ? ? ? 25 ? ? ? ? 89 44 24 38 E8 ? ? ? ? 0F B7 44 24 ? 66 89 44 24 ? 8B 44 24 38 0D ? ? ? ? 0F BA F0 1C 89 44 24 38").count(1).get(0).get<void>()); return oIS_MODEL_IN_CDIMAGE(hash); }
	//static BOOL IS_MODEL_VALID(Hash model) { return invoke<BOOL>(0xC0296A2EDF545E92, model); } // 0xC0296A2EDF545E92 0xAF8F8E9D
	typedef bool(__fastcall* tIS_MODEL_VALID)(DWORD hash);
	static bool IS_MODEL_VALID(DWORD hash) { static tIS_MODEL_VALID oIS_MODEL_VALID = (tIS_MODEL_VALID)(Memory::pattern("48 83 EC 28 8B 44 24 38 48 8D 54 24 ? C7 44 24 ? ? ? ? ? 0D ? ? ? ? 25 ? ? ? ? 89 44 24 38 E8 ? ? ? ? 0F B7 44 24 ? 66 89 44 24 ? 8B 44 24 38 0D ? ? ? ? 0F BA F0 1C 0F B7 C8").count(1).get(0).get<void>()); return oIS_MODEL_VALID(hash); }
	//static BOOL IS_MODEL_A_VEHICLE(Hash model) { return invoke<BOOL>(0x19AAC8F07BFEC53E, model); } // 0x19AAC8F07BFEC53E 0xFFFC85D4
	typedef BOOL(__fastcall* tIS_MODEL_A_VEHICLE)(DWORD hash);
	static BOOL IS_MODEL_A_VEHICLE(DWORD hash) { static tIS_MODEL_A_VEHICLE oIS_MODEL_A_VEHICLE = (tIS_MODEL_A_VEHICLE)(Memory::pattern("40 53 48 83 EC 20 48 8D 54 24 ? 33 DB C7 44 24 ? ? ? ? ? E8 ? ? ? ? 48 85 C0").count(1).get(0).get<void>()); return oIS_MODEL_A_VEHICLE(hash); }
	...
	typedef BOOL(__fastcall* tREQUEST_ANIM_DICT)(char* dict);
	static BOOL REQUEST_ANIM_DICT(char* dict) { static tREQUEST_ANIM_DICT oREQUEST_ANIM_DICT = (tREQUEST_ANIM_DICT)(Memory::pattern("48 83 EC 58 48 8B D1 33 C9").count(1).get(0).get<void>()); return oREQUEST_ANIM_DICT(dict); }
	...
	typedef BOOL(__fastcall* tHAS_ANIM_DICT_LOADED)(char* animDict);
	static BOOL HAS_ANIM_DICT_LOADED(char* animDict) { static tHAS_ANIM_DICT_LOADED oHAS_ANIM_DICT_LOADED = (tHAS_ANIM_DICT_LOADED)(Memory::pattern("48 83 EC 28 48 8B D1 33 C9 E8 ? ? ? ? 48 8D 54 24 ? 48 8D 4C 24 ? 89 44 24 40").count(1).get(0).get<void>()); return oHAS_ANIM_DICT_LOADED(animDict); }
	...
	static void REQUEST_NAMED_PTFX_ASSET2(const char* assetName) { invoke<Void>(0xB80D8756B4668AB6, assetName); } // 0xB80D8756B4668AB6 0xCFEA19A9
...
namespace UI
{
	...
	typedef BOOL(__fastcall* t_DRAW_NOTIFICATION)(BOOL blink, BOOL p1);
	static BOOL _DRAW_NOTIFICATION(BOOL blink, BOOL p1) { static t_DRAW_NOTIFICATION o_DRAW_NOTIFICATION = (t_DRAW_NOTIFICATION)(Memory::pattern("48 89 5C 24 ? 48 89 74 24 ? 57 48 81 EC ? ? ? ? 83 3D ? ? ? ? ? 41 8A D8").count(1).get(0).get<void>()); return o_DRAW_NOTIFICATION(blink, p1); }	
	...
	inline void BEGIN_TEXT_COMMAND_DISPLAY_TEXT2(const char* text) { invoke<Void>(0x25FBB336DF1804CB, text); } // 0x25FBB336DF1804CB 0x3E35563E
	static void BEGIN_TEXT_COMMAND_DISPLAY_TEXT(char* text) { invoke<Void>(0x25FBB336DF1804CB, text); } // 0x25FBB336DF1804CB 0x3E35563E
	inline void END_TEXT_COMMAND_DISPLAY_TEXT2(float x, float y, Any p2) { invoke<Void>(0xCD015E5BB0D96A57, x, y, p2); } // 0xCD015E5BB0D96A57 0x6F8350CE
...
namespace GRAPHICS
{
	...
	static BOOL START_PARTICLE_FX_NON_LOOPED_ON_ENTITY2(const char* effectName, Entity entity, float offsetX, float offsetY, float offsetZ, float rotX, float rotY, float rotZ, float scale, BOOL axisX, BOOL axisY, BOOL axisZ) { return invoke<BOOL>(0x0D53A3B8DA0809D2, effectName, entity, offsetX, offsetY, offsetZ, rotX, rotY, rotZ, scale, axisX, axisY, axisZ); } // 0x0D53A3B8DA0809D2 0x9604DAD4
	...
	static BOOL BEGIN_SCALEFORM_MOVIE_METHOD(int scaleform, const char* functionName) { return invoke<BOOL>(0xF6E48914C7A8694E, scaleform, functionName); } // 0xF6E48914C7A8694E 0x215ABBE8
...
namespace NETWORK
{
	...
	typedef BOOL(__fastcall* tNETWORK_REQUEST_CONTROL_OF_NETWORK_ID)(int netId);
	static BOOL NETWORK_REQUEST_CONTROL_OF_NETWORK_ID(int netId) { static tNETWORK_REQUEST_CONTROL_OF_NETWORK_ID oNETWORK_REQUEST_CONTROL_OF_NETWORK_ID = (tNETWORK_REQUEST_CONTROL_OF_NETWORK_ID)(Memory::pattern("40 53 48 83 EC 20 8B D9 E8 ? ? ? ? 8B D3 48 8B C8 E8 ? ? ? ? 48 85 C0 74 2C").count(1).get(0).get<void>()); return oNETWORK_REQUEST_CONTROL_OF_NETWORK_ID(netId); }
	...
	typedef BOOL(__fastcall* tNETWORK_HAS_CONTROL_OF_ENTITY)(Entity entity);
	static BOOL NETWORK_HAS_CONTROL_OF_ENTITY(Entity entity) { static tNETWORK_HAS_CONTROL_OF_ENTITY oNETWORK_HAS_CONTROL_OF_ENTITY = (tNETWORK_HAS_CONTROL_OF_ENTITY)(Memory::pattern("48 83 EC 28 E8 ? ? ? ? 48 85 C0 74 1F 48 8B 88 ? ? ? ? 48 85 C9 74 0F").count(1).get(0).get<void>()); return oNETWORK_HAS_CONTROL_OF_ENTITY(entity); }
...
namespace UNK3
{
	...
	static BOOL _NETWORK_SHOP_BEGIN_SERVICE(Any* value, Any p1, Any p2, Any p3, Any p4, int p5) { return invoke<BOOL>(0x3C5FD37B5499582E, value, p1, p2, p3, p4, p5); }
